...
export class ComponentGroup {
  ...
  /** Name of the package, either ng-extra, mat-extra or ion-extra */
  packageName: string;
...
/**
 * Processor to group docs into top-level "Components",
...
export class ComponentGrouper implements Processor {
  ...
  $process(docs: DocCollection) {
    ...
    docs.forEach(doc => {
      ...
      const packageDisplayName = documentInfo.packageName === 'ng-extra' ? 'Ng-Extra' :
        (documentInfo.packageName === 'mat-extra' ? 'Mat-Extra' : 'Ion-Extra');

      const moduleImportPath = `@gnucoop/${packageName}/${documentInfo.entryPointName}`;
