...
task('prerender', ['universal:build'], execTask(
  // Runs node with the tsconfig-paths module to alias the @gnucoop/ng-extra dependency.
...
task('universal:build', sequenceTask(
  'clean',
  ['mat-extra:build-release', 'ion-extra:build-release', 'ng-extra:build-release'],
...
// copy the Ng-Extra, Mat-Extra and Ion-Extra ESM output inside of the universal-app output.
