...
/** Path to the output of the Ng-Extra package. */
const ngExtraOutPath = join(buildConfig.outputDir, 'packages', 'ng-extra');

/** Path to the output of the Mat-Extra package. */
const matExtraOutPath = join(buildConfig.outputDir, 'packages', 'mat-extra');

/** Path to the output of the Ion-Extra package. */
const ionExtraOutPath = join(buildConfig.outputDir, 'packages', 'ion-extra');
...
/** Task to lint Ng-Extra's scss stylesheets. */
...
task('madge', ['mat-extra:clean-build', 'ion-extra:clean-build'], () => {
  madge([matExtraOutPath, ionExtraOutPath, ngExtraOutPath]).then((res: any) => {
