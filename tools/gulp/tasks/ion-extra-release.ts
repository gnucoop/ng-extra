...
// Path to the release output of ion-extra.
const releasePath = join(releasesDir, 'ion-extra');
 ...
 */
task('ion-extra:build-release', ['ion-extra:prepare-release'],
 ...
 */
task('ion-extra:prepare-release', sequenceTask(
  'ion-extra:build',
  ['ion-extra:copy-prebuilt-themes', 'ion-extra:bundle-theming-scss']
));

/** Copies all prebuilt themes into the release package under `prebuilt-themes/` */
task('ion-extra:copy-prebuilt-themes', () => {
...
task('ion-extra:bundle-theming-scss', () => {
